...
//        calculatricePanel.setPreferredSize(new Dimension(500,500));
    ...
    private void createBlackScreen() {
        ...
        bagConstraints.gridwidth = 4; // Définit la largeur occupée par le composant sur 5 cellules
    ...
    private void createButton() {
        ...
        for (String s : buttons) { // Boucle à travers le tableau de chaînes "buttons"
            ...
            bagConstraints.weighty = 1; // Chaque autre bouton a un poid de 0.5
