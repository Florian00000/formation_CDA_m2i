...
public class Main {
    public static void main(String[] args) {
        ProxyDocument document1 = new ProxyDocument(new RealDocument("document1", "contenue test1"));
        ProxyDocument document2 = new ProxyDocument(new RealDocument("document2", "contenue test2"));
